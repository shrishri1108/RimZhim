...
public class InboxAdapter1 extends RecyclerView.Adapter<InboxAdapter1.CustomViewHolder> implements Filterable {
    public Context context;
    ArrayList<InboxModel> inboxDataList = new ArrayList<>();
    ArrayList<InboxModel> inboxDataListFilter = new ArrayList<>();
    private InboxAdapter1.OnItemClickListener listener;
    private InboxAdapter1.OnLongItemClickListener longlistener;
    ...
    public InboxAdapter1(Context context, ArrayList<InboxModel> user_dataList, InboxAdapter1.OnItemClickListener listener, InboxAdapter1.OnLongItemClickListener longlistener) {
    ...
    @Override
    public InboxAdapter1.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_inbox_list, null);
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT));
        InboxAdapter1.CustomViewHolder viewHolder = new InboxAdapter1.CustomViewHolder(view);
        return viewHolder;
    }
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final InboxModel item, final InboxAdapter1.OnItemClickListener listener, final InboxAdapter1.OnLongItemClickListener longItemClickListener) {
    ...
    @Override
    public void onBindViewHolder(final InboxAdapter1.CustomViewHolder holder, final int i) {
