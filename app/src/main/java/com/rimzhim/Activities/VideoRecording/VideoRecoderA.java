...
import com.rimzhim.Interfaces.ProgressBarListener;
...
import com.rimzhim.SimpleClasses.SegmentedProgressBar;
...
public class VideoRecoderA extends AppCompatLocaleActivity implements View.OnClickListener {
 //   GLSurfaceView sampleGLView;
  ...
  //  GPUPlayerView gpuPlayerView;
    TextView done_btn, done_filter_btn;
  ...
  //  FilterAdapter adapter;
    ...
    String isSelected;
    ImageButton flashBtn, goBack;
    SegmentedProgressBar videoProgress;
    LinearLayout cameraOptions, cameraOptionText;
    ImageButton rotateCamera, cutVideoBtn;



    TextView addSoundTxt, currentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraOptions = (LinearLayout)findViewById(R.id.camera_options);
        cameraOptionText = (LinearLayout)findViewById(R.id.cameraOptionText);
        recordImage = (ImageButton) findViewById(R.id.record_image);
        goBack = (ImageButton) findViewById(R.id.goBack);
        //currentTime =(TextView)findViewById(R.id.currentTime);
        recylerview =(RecyclerView)findViewById(R.id.recylerview);
        reLaout =(RelativeLayout)findViewById(R.id.reLaout);
      //  done_btn =(TextView)findViewById(R.id.done_btn);
        done_filter_btn =(TextView)findViewById(R.id.done_filter_btn);
        ...
        cutVideoBtn = (ImageButton)findViewById(R.id.cut_video_btn);
       ...
       /* flashBtn = findViewById(R.id.flash_camera);
        ...
        shortVideoTimeTxt = (TextView)findViewById(R.id.short_video_time_txt);
        longVideoTimeTxt = (TextView)findViewById(R.id.long_video_time_txt);
    ...
    //    textView = (TextView) view.findViewById(R.id.textView1);
       ...
       /* view.findViewById(R.id.stop).setOnClickListener(
        ...
        done_filter_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                recylerview.setVisibility(View.GONE);
                done_filter_btn.setVisibility(View.GONE);
       ...
       // ((MovieWrapperView) findViewById(R.id.layout_movie_wrapper)).addView(cameraView);
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK ) {
                       ...
                       /* if (TrimmerUtils.getDuration(VideoRecoderA.this,data.getData())<Constants.MIN_TRIM_TIME){
                            Toast.makeText(VideoRecoderA.this,"Video should be larger than 5 sec",Toast.LENGTH_SHORT).show();
                            return;
                        }
                    ...
                    public void run() {
                        currentTime.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                currentTime.setText((minute>9?minute:("0"+ minute))+":"+ (seconds>9?seconds :"0"+ seconds));
...
*/
            ...
            recordImage.setImageDrawable(getResources().getDrawable(R.drawable.ic_record_btn_svg));
            ...
            cameraOptionText.setVisibility(View.GONE);
           ...
           //  t.cancel();
            ...
            findViewById(R.id.filter_layout).setEnabled(true);
            recordImage.setImageDrawable(getResources().getDrawable(R.drawable.ic_recording_circle_svg));
            cameraOptions.setVisibility(View.VISIBLE);
            cameraOptionText.setVisibility(View.VISIBLE);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    Functions.showToast(VideoRecoderA.this, "Please wait");
                                } catch (Exception e) {
                                }
                            }
                        });
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
           ...
           /* case R.id.cut_video_btn:
                Functions.showAlert(this, "", "Discard the last clip?", "Delete", "Cancel", new Callback() {
                    @Override
    ...
    public void preparedAudio() {
        ...
        if (file.exists()) {
            ...
            catch (Exception e)
            {
                ...
                Toast.makeText(this, "you cannot create a video using this sound", Toast.LENGTH_SHORT).show();
                finish();
            }
