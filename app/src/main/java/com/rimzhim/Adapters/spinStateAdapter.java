...
public class spinStateAdapter extends ArrayAdapter {
    ...
    public spinStateAdapter(@NonNull Context context, int resource, Context context1, int textViewResourceId, ArrayList<ListItem> list, Boolean hideTop) {
