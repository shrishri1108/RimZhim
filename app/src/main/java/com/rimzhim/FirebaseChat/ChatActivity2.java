package com.rimzhim.FirebaseChat;
...
public class ChatActivity2 extends AppCompatActivity {
        ...
        userquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    name.setText(nameh);
                    try {
                        Glide.with(ChatActivity2.this).load(image).placeholder(R.drawable.ic_user_icon).into(profile);
                    } catch (Exception e) {
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    adapterChat = new AdapterChat(ChatActivity2.this, chatList, image);
    ...
    private Boolean checkStoragePermission() {
        boolean result = ContextCompat.checkSelfPermission(ChatActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
        return result;
    }
